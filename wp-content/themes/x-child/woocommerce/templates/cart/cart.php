  ...
  <table class="shop_table cart" cellspacing="0">
    <thead>
      <tr>
        ...
        <th class="product-price"><?php _e( 'Estimated Price', '__x__' ); ?></th>
        <th class="product-quantity"><?php _e( 'Quantity', '__x__' ); ?></th>
        <th class="product-subtotal"><?php _e( 'Estimated Total', '__x__' ); ?></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        <td colspan="6" class="actions">
          ...
          <div class="update action-group">
            <input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Quote', '__x__' ); ?>" />
