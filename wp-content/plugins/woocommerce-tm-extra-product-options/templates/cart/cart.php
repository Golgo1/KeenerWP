...
<table class="shop_table cart" cellspacing="0">
	<thead>
		<tr class="tm-epo-cart-row-header">
			...
			<th class="product-price"><?php _e( 'Estimated Price', 'woocommerce' ); ?></th>
			<th class="product-quantity"><?php _e( 'Quantity', 'woocommerce' ); ?></th>
			<th class="product-subtotal"><?php _e( 'Estimated Total', 'woocommerce' ); ?></th>
			<?php
	...
	<tbody>
					...
					<td class="product-price">
						<?php
							if (TM_EPO()->tm_epo_hide_options_in_cart=="normal"){
								echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $original_product ), $cart_item, $cart_item_key );
							}else{
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Quote', 'woocommerce' ); ?>" />
